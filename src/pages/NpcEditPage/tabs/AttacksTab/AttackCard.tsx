  ...
  return (
    <article className={styles.attackCard}>
      ...
      <div className={styles.attackField}>
        ...
        <SimpleWysiwygEditor ariaLabel={t('pages.characterEdit.abilities.descriptionLabel')} minHeightClassName={styles.attackTextarea} name={`npc-attack-description-${index}`} pasteAsPlainText placeholder={t('pages.npcEdit.attacks.descriptionPlaceholder')} toolbar={false} value={attack.description} onChange={(value) => onAttackChange(index, 'description', value)} />
      </div>
    </article>
  )
}
