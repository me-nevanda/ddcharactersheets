...
import { CharacterRace, type CharacterAttributeBonuses, type CharacterItems, type CharacterSkillBonuses, type CharacterTraining, } from '../../../../types/character';
...
export const buildSkillBonuses = (level: number, attributeBonuses: CharacterAttributeBonuses, training: CharacterTraining, race: CharacterRace, items: CharacterItems): CharacterSkillBonuses => {
...
export const buildSkillModifiers = (skillBonuses: CharacterSkillBonuses): Record<keyof CharacterTraining, string> => {
