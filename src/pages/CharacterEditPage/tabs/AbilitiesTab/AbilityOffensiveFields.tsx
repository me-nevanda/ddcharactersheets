...
export function AbilityOffensiveFields({
  ability,
  index,
  attributeOptions,
  attackBonusOptions,
        ...
        <div className={styles.abilityWeaponTargetRow}>
          <label className={styles.abilityWeaponTargetGroup} htmlFor={`ability-weapon-attack-attribute-${index}`}>
            <select
              ...
              onChange={(event) => onAbilityChange(index, 'weaponAttackAttribute', event.target.value)}
            >
          ...
          <div className={styles.abilityWeaponAttackBonusGroup}>
            <div className={styles.abilityWeaponAttackBonusControl}>
              ...
              <select
                ...
                onChange={(event) =>
                  onAbilityChange(index, 'weaponAttackBonusNumber', Number.parseInt(event.target.value, 10) || 0)
                }
              >
          ...
          <label className={styles.abilityWeaponTargetGroup} htmlFor={`ability-weapon-attack-defense-${index}`}>
            <select
              ...
              onChange={(event) => onAbilityChange(index, 'weaponAttackDefense', event.target.value)}
            >
        ...
        <div className={styles.abilityWeaponRowSecondary}>
          <label className={styles.abilityWeaponDiceGroup} htmlFor={`ability-weapon-dice-${index}`}>
            ...
            <select
              ...
              onChange={(event) => onAbilityChange(index, 'weaponDamageDiceType', event.target.value)}
            >
          ...
          <select
            ...
            onChange={(event) => onAbilityChange(index, 'weaponAttributeBonus', event.target.value)}
          >
          ...
          <label className={styles.abilityWeaponCountGroup} htmlFor={`ability-weapon-damage-type-${index}`}>
            ...
            <select
              ...
              onChange={(event) => onAbilityChange(index, 'weaponDamageType', event.target.value)}
            >
          ...
          <div className={styles.abilityWeaponTextAreaField}>
            ...
            <div className={styles.abilityWeaponRowSecondary}>
              ...
              <select
                ...
                onChange={(event) => onAbilityChange(index, 'weaponRecurringDamageType', event.target.value)}
              >
                {weaponDamageTypeOptions.map((option) => (
                  <option key={option.value} value={option.value}>
                    {option.label}
        ...
        <div className={styles.abilityWeaponTextAreaSoloRow}>
          <label className={styles.abilityWeaponTextAreaField} htmlFor={`ability-weapon-provocation-${index}`}>
            ...
            <textarea
              ...
              onChange={(event) => onAbilityChange(index, 'weaponProvocation', event.target.value)}
            />
          </label>
        </div>
        ...
        <div className={styles.abilityWeaponTextAreaFullRow}>
          <label className={styles.abilityWeaponTextAreaField} htmlFor={`ability-weapon-hit-${index}`}>
            ...
            <textarea
              ...
              onChange={(event) => onAbilityChange(index, 'weaponHit', event.target.value)}
            />
          </label>
        </div>
        ...
        <div className={styles.abilityWeaponTextAreaFullRow}>
          <label className={styles.abilityWeaponTextAreaField} htmlFor={`ability-weapon-miss-${index}`}>
            ...
            <textarea
              ...
              onChange={(event) => onAbilityChange(index, 'weaponMiss', event.target.value)}
            />
          </label>
        </div>
      </div>
