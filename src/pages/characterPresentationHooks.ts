...
export const useCharacterPresentation = () => {
    const { t } = useI18n();
    const getCharacterLabel = (name: string | null | undefined): string => {
        return name || t('pages.characterList.unnamedCharacter');
    };
    const getRaceLabel = (race: CharacterRace | string): string => {
    ...
    const getClassLabel = (characterClass: CharacterClass | string): string => {
    ...
    const getGenderLabel = (gender: CharacterGender | string): string => {
    ...
    const getAlignmentLabel = (alignment: CharacterAlignment | string): string => {
    ...
    const getCharacterPortraitSrc = (race: CharacterRace | string, gender: CharacterGender | string): string => {
    ...
    const getCharacterClassSrc = (characterClass: CharacterClass | string): string => {
