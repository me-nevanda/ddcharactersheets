          ...
          <form id="map-edit-form" className={styles.editorForm} onSubmit={(event) => void handleSubmit(event)}>
            ...
            <section className={`${styles.mapEditorSection} ${isMapFullscreen ? styles.mapEditorSectionFullscreen : ''}`} aria-label={t('pages.mapEdit.editorLabel')}>
              <div className={styles.mapWorkspace}>
                <div className={`${styles.mapGrid} ${activeLayer === 'lines' && selectedDrawMode === 'single' ? styles.mapGridSingleMode : ''}`} aria-label={t('pages.mapEdit.editorLabel')} onClick={handleMapClick} onContextMenu={handleMapContextMenu} onPointerCancel={handleMapPointerUp} onPointerDown={handleMapPointerDown} onPointerMove={handlePreviewMapPointer} onPointerLeave={handleClearLinePreview} onPointerUp={handleMapPointerUp}>
