...
import { buildCharacterHp, buildCharacterSpeed, buildCharacterSurge, clampSpeedValue, getLevelBonus, } from '@pages/CharacterEditPage/sections/GeneralSection/generalSectionLogic';
