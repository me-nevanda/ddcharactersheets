...
export const pl: TranslationDictionary = {
  ...
  pages: {
    ...
    areaList: {
      ...
      emptySearchState: 'Brak obszarów pasujących do wyszukiwania.',
      loading: 'Wczytywanie obszarów...',
      searchLabel: 'Szukaj obszarów',
      searchPlaceholder: 'Szukaj po nazwie obszaru',
      unnamedArea: 'Obszar bez nazwy',
      updatedAt: 'Ostatnia zmiana:',
      deleteDialog: {
        title: 'Usunąć obszar?',
        body: 'Obszar „{name}” zostanie usunięty na stałe.',
      },
    },
    eventList: {
      actions: {
      ...
      emptySearchState: 'Brak wydarzeń pasujących do wyszukiwania.',
      loading: 'Wczytywanie wydarzeń...',
      searchLabel: 'Szukaj wydarzeń',
      searchPlaceholder: 'Szukaj po nazwie wydarzenia',
      unnamedEvent: 'Wydarzenie bez nazwy',
      updatedAt: 'Ostatnia zmiana:',
      deleteDialog: {
    ...
    eventEdit: {
      ...
      placeholders: {
        titleName: 'Wydarzenie bez nazwy',
    ...
    mapEdit: {
      contextCopyError: 'Nie udało się skopiować kontekstu mapy.',
      contextCopySuccess: 'Skopiowano kontekst mapy.',
      copyingContextButton: 'Kopiowanie...',
      copyContextButton: 'Kontekst',
      ...
      groundPaletteLabel: 'Podłoża',
      groundTextureLabel: 'Podłoże {number}',
      groundTextureVariants: {
        grass: 'Trawa',
        water: 'Woda',
        sand: 'Piasek',
        woodenFloor: 'Drewniana podłoga',
        gravel: 'Żwir',
        cobblestone: 'Bruk',
        ice: 'Lód',
        lava: 'Lawa',
        stoneFloor: 'Kamienna podłoga',
        parquet: 'Parkiet',
        stonyGround: 'Kamieniec',
        woodenTerrace: 'Drewniany taras',
        swamp: 'Bagno',
        crackFissure: 'Pęknięcie/Szczelina',
        unevenTerrain: 'Nierówny teren',
      },
      elementPaletteLabel: 'Elementy',
      elementCategoryLabel: '{category}',
      elementAssetLabel: '{category} {number}',
      elementVariantHint: 'Kliknij dwa razy na element, aby wybrać jego inny typ.',
      toggleElementLabel: 'Przełącz element mapy',
      toggleGroundCellLabel: 'Przełącz podłoże',
      toggleLabelLabel: 'Przełącz opis mapy',
      toggleLineLabel: 'Przełącz linię mapy',
      labelNameInputLabel: 'Nazwa opisu',
      confirmLabelNameLabel: 'Zatwierdź nazwę opisu',
      layers: {
        lines: 'Linie',
        ground: 'Podłoże',
        elements: 'Elementy',
      ...
      elementTreeVariants: {
        ...
        fantasy: 'Drzewo fantazyjne',
        modeled: 'Drzewo modelowane',
        fallen: 'Drzewo powalone',
        stump: 'Pieniek',
      },
      elementBushVariants: {
        regular: 'Krzak zwykły',
        yellowFlowers: 'Krzak kwiatki żółte',
        whiteFlowers: 'Krzak kwiatki białe',
        threeSmall: 'Trzy małe krzaki',
        hedge: 'Żywopłot',
        plants: 'Roślinki',
        twoSmall: 'Dwa małe krzaki',
        fruit: 'Krzak owocowy',
      },
      elementStairVariants: {
        upDownStairs: 'Schody góra/dół',
        leftRightStairs: 'Schody lewo/prawo',
        ladderUp: 'Drabina w górę',
        ladderDown: 'Drabina w dół',
        entranceUp: 'Wejście na górę',
        descentDown: 'Zejście w dół',
      },
      elementFurnitureVariants: {
        shelf: 'Regał',
        cabinet: 'Szafka',
        tableDesk: 'Stół/Biurko',
        bed: 'Łóżko',
        couch: 'Kanapa',
        armchair: 'Fotel',
        chair: 'Krzesło',
        fireplace: 'Kominek',
        shopCounter: 'Lada sklepowa',
        smallTable: 'Stolik',
        altar: 'Ołtarz',
      },
      elementStoneVariants: {
        rubble: 'Rumowisko',
        rocks: 'Skały',
        threeStones: 'Trzy kamienie',
        menhirs: 'Menhiry',
        largeStone: 'Duży kamień',
        mossyStone: 'Kamień z mchem',
        crackedStone: 'Pęknięty kamień',
        magicStone: 'Magiczny kamień',
      ...
      elementMiscVariants: {
        chest: 'Skrzynia',
        vase: 'Waza',
        woodenCrate: 'Drewniana skrzynia',
        campfire: 'Ognisko',
        drainGrate: 'Kratka ściekowa',
        column: 'Kolumna',
        brokenColumn: 'Uszkodzona kolumna',
        well: 'Studnia',
        fountain: 'Fontanna',
        barrel: 'Beczka',
        signpost: 'Drogowskaz',
    ...
    contextList: {
      ...
      emptySearchState: 'Brak kontekstów pasujących do wyszukiwania.',
      loading: 'Wczytywanie kontekstów...',
      searchLabel: 'Szukaj kontekstów',
      searchPlaceholder: 'Szukaj po nazwie kontekstu',
      unnamedContext: 'Kontekst bez nazwy',
      updatedAt: 'Ostatnia zmiana:',
      deleteDialog: {
    ...
    contextEdit: {
      ...
      copy: {
        ...
        singleMonsterIntro: 'Przedstawiam ci opis potwora {name}. Przeczytaj go i czekaj na dalsze instrukcje.',
    ...
    characterList: {
      ...
      emptySearchState: 'Brak bohaterów pasujących do wyszukiwania.',
      searchLabel: 'Szukaj bohaterów',
      searchPlaceholder: 'Szukaj po nazwie bohatera',
      ...
      groups: {
        ...
        emptySearchState: 'Brak grup pasujących do wyszukiwania.',
        searchLabel: 'Szukaj grup bohaterów',
        searchPlaceholder: 'Szukaj po nazwie grupy albo bohatera',
    ...
    monsterList: {
      ...
      groups: {
        ...
        emptySearchState: 'Brak grup pasujących do wyszukiwania.',
        searchLabel: 'Szukaj grup potworów',
        searchPlaceholder: 'Szukaj po nazwie grupy albo potwora',
      ...
      emptySearchState: 'Brak potworów pasujących do wyszukiwania.',
      searchLabel: 'Szukaj potworów',
      searchPlaceholder: 'Szukaj po nazwie potwora',
    ...
    npcList: {
      ...
      groups: {
        ...
        emptySearchState: 'Brak grup pasujących do wyszukiwania.',
        searchLabel: 'Szukaj grup NPC',
        searchPlaceholder: 'Szukaj po nazwie grupy albo NPC',
        emptyNpcs: 'Brak NPC',
        npcCount: 'NPC: {count}',
        moreNpcs: 'Więcej NPC',
        unnamedGroup: 'Nienazwana grupa',
      ...
      emptySearchState: 'Brak NPC pasujących do wyszukiwania.',
      searchLabel: 'Szukaj NPC',
      searchPlaceholder: 'Szukaj po nazwie NPC',
    ...
    monsterEdit: {
      contextCopyError: 'Nie udało się skopiować kontekstu potwora.',
      contextCopySuccess: 'Skopiowano kontekst potwora.',
      copyingContextButton: 'Kopiowanie...',
      copyContextButton: 'Kontekst',
      eyebrow: 'POTWÓR',
      title: 'Potwór',
    ...
    mapPrint: {
      title: 'Wydruk mapy',
      loading: 'Przygotowywanie wydruku mapy...',
      error: 'Nie udało się przygotować wydruku mapy.',
      printButtonLabel: 'Drukuj',
      mapLabel: 'Mapa',
      emptyLegend: 'Brak opisów na mapie.',
      sections: {
        description: 'Opis',
        legend: 'Legenda',
      },
